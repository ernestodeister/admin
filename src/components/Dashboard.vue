              ...
              <v-row md="12" xs="12">
                <v-card class="mx-auto">
                  <v-row align="center">
                    ...
                    <v-col md="5" xs="12" class="" align="center">
              ...
              <v-row md="12" xs="12">
                <v-card class="mx-auto mt-3">
                  <v-row align="center">
                    ...
                    <v-col md="5" xs="12" class="py-2 px-2" align="center">
                      <v-btn color="primary" x-large>
            ...
            <v-col md="8" xs="12">
              <v-row class="px-4">
                <v-card
                  ...
                  :height="this.$vuetify.breakpoint.smAndDown ? '140px' : '220px'"
                  :width="this.$vuetify.breakpoint.smAndDown ? '100%' : '190px'"
                >
...
<script lang="ts">
import TopFiveList from './dashboard/TopFiveList.vue'
